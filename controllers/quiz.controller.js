...
const answers = answersBlock ? answersBlock.match(/[a-d]\)\s*(.+)/gi).map(answer => answer.trim().substring(3)) : [];
...
const correctAnswer = correctAnswerMatch ? correctAnswerMatch[2].trim() : null;
...
console.log("Correct answer:", correctAnswer);
  ...
  return res.status(200).json({ message: "Quiz created successfully", generatedQuestion });
}

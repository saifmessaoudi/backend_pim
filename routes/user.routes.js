...
import { acceptInvitation, getfriendsRequest, refuseInvitation ,addAdmin ,secuser} from "../controllers/user.controller.js";
...
import { registerUser,loginUser,loginUser1,verifyEmail,loginAdmin} from '../controllers/AuthController.js';
import { getAllUsers, getById, updatePassword, updateUser , selectedroulette ,stastverifiedaccount,savePoints} from '../controllers/user.controller.js';
...
router.delete('/deleteUser/:username', deleteUser);
  ...
  router.post('/savepoint/:userId',savePoints );
